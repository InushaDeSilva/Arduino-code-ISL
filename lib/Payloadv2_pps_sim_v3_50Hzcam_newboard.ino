...
unsigned int preload = 25536; //45536;
...
void setup() {
  ...
  TCNT4 = 45536; //25536;            // preload timer 65536-16MHz/8/100Hz  - 50Hz overflow
...
ISR(TIMER4_OVF_vect)        // interrupt service routine that wraps a user defined function supplied by attachInterrupt
{
  ...
  if(flag_pps_sim_high && pps_width_count>=cam_pps_preload+17){  // 19 =>380ms
    //digitalWrite(3,LOW);
